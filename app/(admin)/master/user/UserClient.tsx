                ...
                <div className="flex flex-col sm:flex-row items-center gap-3">
                    {currentRole === "superadmin" && (
                        <select
                            ...
                            className="w-full sm:w-auto px-4 py-2.5 rounded-full border border-[var(--color-border)] bg-[var(--color-bg-elevated)] text-[var(--color-text-main)] text-[13px] font-semibold focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary shadow-sm"
                        >
                            <option value="all">Semua Instansi / Perusahaan</option>
                            {companies.map(c => (
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="space-y-1.5 col-span-2 sm:col-span-1">
                                    ...
                                    <select
                                        ...
                                        className="w-full px-3 py-2.5 rounded-[var(--radius-sm)] border border-[var(--color-border)] bg-[var(--color-bg-elevated)] text-[var(--color-text-main)] text-sm focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all cursor-pointer font-semibold"
                                    >
                                        <option value="user">User / Kandidat</option>
