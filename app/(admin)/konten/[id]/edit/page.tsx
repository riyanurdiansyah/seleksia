    ...
    const handleGenerateAI = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                alert(err.error || "Gagal meng-generate ulang artikel dengan AI");
            }
        } catch (error) {
    ...
    if (fetching) {
        return (
            <div className="flex flex-col items-center justify-center py-24 gap-3">
                ...
                <span className="text-sm font-semibold text-[var(--color-text-sub)]">Memuat data artikel...</span>
            </div>
        );
    }
        ...
        <div className="space-y-6 animate-fade-in pb-12">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[var(--color-border)] pb-4">
                ...
                <div className="flex items-center gap-3">
                    <a
                        href={`/artikel/${formData.slug}`}
                        target="_blank"
                        rel="noreferrer"
                        className="px-3.5 py-2 rounded-xl text-xs font-bold bg-[var(--color-bg-elevated)] text-[var(--color-text-main)] border border-[var(--color-border)] hover:border-primary transition-all flex items-center gap-1.5"
                    >
                    ...
                    >
                        ...
                        {showAiBox ? "Tutup AI Studio" : "Buka AI Studio"}
                    </button>
                </div>
            </div>

            {/* AI Assistant Box Banner */}
            {showAiBox && (
                    ...
                    <div className="relative z-10 space-y-4">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2.5">
                                ...
                                <div>
                                    <h2 className="text-lg font-bold tracking-tight">AI Content Rewriter & Enhancer</h2>
                                    <p className="text-xs text-purple-200">Gunakan AI untuk menyempurnakan atau menulis ulang artikel ini secara otomatis.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2">
                            <div className="md:col-span-2">
                                <label className="block text-xs font-extrabold uppercase tracking-wider text-purple-200 mb-1.5">Topik Utama</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="block text-xs font-extrabold uppercase tracking-wider text-purple-200 mb-1.5">Keywords SEO</label>
                                <input
                                    type="text"
                            ...
                            >
                                {generating ? (
                                    <>
                                        ...
                                        <span>AI Sedang Menulis Ulang...</span>
                                    </>
                                ) : (
                                    <>
                                        <span className="material-symbols-outlined text-base">magic_button</span>
                                        <span>Re-Generate Artikel dengan AI</span>
                                    </>
                                )}
                            </button>
                        </div>
