            ...
            <div className="hidden lg:flex lg:w-[55%] bg-gradient-to-br from-[#1A3C40] via-[#0c5c64] to-[#059669] relative overflow-hidden flex-col justify-between p-16">
                ...
                <div className="relative z-10 max-w-xl my-auto space-y-8">
                    <h2 className="text-4xl font-extrabold leading-[1.15] text-white tracking-tight">
                        Lupa <span className="text-white/80">Kata Sandi?</span>
                    </h2>
                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    {success ? (
                        <div className="bg-[var(--color-success-light)] border border-[var(--color-success)] text-[var(--color-success)] px-4 py-3 rounded-lg flex items-start gap-3">
                            ...
                            <div>
                                <h3 className="font-bold text-sm">Email Terkirim!</h3>
                                <p className="text-xs mt-1">Kami telah mengirimkan tautan reset password ke email Anda. Silakan cek kotak masuk atau folder spam Anda.</p>
                                <a href="/login" className="inline-block mt-3 text-sm font-bold underline hover:text-[var(--color-success-dark)]">Kembali ke Login</a>
                            </div>
                        </div>
                    ) : (
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="text-center pt-2">
                                <a href="/login" className="text-sm font-semibold text-[var(--color-text-muted)] hover:text-[var(--color-primary)] transition-colors">
